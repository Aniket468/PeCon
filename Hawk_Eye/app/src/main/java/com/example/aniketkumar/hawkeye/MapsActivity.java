                   ...
                   // Log.e("lati ",""+lat);
                    ...
                    //Log.e("Time",time);
                     ...
                     if(i==contacts.length()-1)
                         mMap.addMarker(new MarkerOptions().position(new LatLng(lat, lon)).title(name+" Last location").snippet(time)
                ...
                try {
                    ...
                    for (int i = 0; i < contacts.length(); i++) {
                       ...
                       // Log.e("LATITUDE ", latitude);
                        ...
                        if(q==1)
                        mMap.addMarker(new MarkerOptions().position(new LatLng(lat,lon)).title(name).snippet(time));
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<HashMap<String, String>>> {
        ...
        protected void onPostExecute(List<HashMap<String, String>> list) {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                // Getting name
                String nam = hmPlace.get("place_name");

                Log.d("Map", "place: " + nam);
                mMap.addMarker(new MarkerOptions().position(new LatLng(lat, lng)).title(nam).snippet("nearby places around "+name)
...
if(i==0)
{
    ...
    mMap.addMarker(new MarkerOptions().position(new LatLng(l1, l2)).title(name+"'s"+"Location")
            .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_ORANGE)));
...
//    mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(India,17.0f));
    ...
    public StringBuilder sbMethod() {
      ...
      String mLatitude=la1;
        ...
        sb.append("&types=" + "train_station|airport|bus_station|amusement_park|movie_theater|park|night_club|casino|shopping_mall|hospital");
